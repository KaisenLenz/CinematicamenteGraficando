 ...
 */
package vista;
import Controlador.IniciadorAntlr;
import Controlador.RedirectAppOutputStream2;
...
public class Menu_principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtEntrada.setFont(new java.awt.Font("Lato Black", 0, 13)); // NOI18N
        txtEntrada.setRows(5);
        jScrollPane1.setViewportView(txtEntrada);

        jLabel1.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Cinematicamente Graficando");

        txtSalida.setBackground(new java.awt.Color(0, 0, 0));
        txtSalida.setColumns(20);
        txtSalida.setFont(new java.awt.Font("Consolas", 0, 13)); // NOI18N
        ...
        btnLimpiar.setText("Limpiar Editor");
        ...
        btnTree.setText("Mostrar ParserTree");
    ...
    private void btnTreeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTreeActionPerformed
        ...
        IniciadorAntlr antlr = new IniciadorAntlr();
        antlr.MostrarArbol(codigo);
    ...
    private void btnEjecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEjecutarActionPerformed
        ...
        if(codigo.isBlank())
        {
            JOptionPane.showMessageDialog(this, "La entrada esta vacia", "Error 1", JOptionPane.ERROR_MESSAGE);
        }
        else
        {
            txtSalida.setText("");
            IniciadorAntlr antlr = new IniciadorAntlr();
            RedirectAppOutputStream2 a = new RedirectAppOutputStream2();
            a.guiConsoleTest(txtSalida);
            antlr.Ejecutar(codigo);
        }
